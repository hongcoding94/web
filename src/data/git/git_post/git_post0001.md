...
| --- | --- | --- | --- | --- |
| 시간 기반 효율성 | 12s |  확인불가 | 확인불가 | 확인불가 |
| 비용 기반 효율성 | 10,000건 ÷ 0원 | 정의 불가 | ∞ × 0.97 = ∞ | 사용자가 지정한 시간에 의해 돌아가는 대규모 배치를 비용 소모 없이 무상 자원으로 해결하여 비용 가치 극대화 |
...
- 시간 기준: 스케줄에 의거하여 지정된 시간에 자동으로 실행되어, 사람 손으로 하기 힘든 양의 데이터를 실수 없이 빠르게 처리한다.
